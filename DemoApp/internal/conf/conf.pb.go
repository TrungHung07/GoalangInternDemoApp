...
type Data struct {
	...
	Kafka         *Data_Kafka            `protobuf:"bytes,3,opt,name=kafka,proto3" json:"kafka,omitempty"` // Add this
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data_Kafka_Producer) GetTopic() string {
	if x != nil {
		return x.Topic
	}
	return ""
...
type Data_Kafka_Consumer struct {
	...
	AutoOffsetReset string                 `protobuf:"bytes,3,opt,name=auto_offset_reset,json=autoOffsetReset,proto3" json:"auto_offset_reset,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Data_Kafka_Consumer) GetTopic() string {
	if x != nil {
		return x.Topic
	}
	return ""
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\x88\x06\n" +
	"\x04Data\x125\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\x1a\xfa\x02\n" +
	"\x05Kafka\x12\x18\n" +
	"\abrokers\x18\x01 \x03(\tR\abrokers\x12;\n" +
	"\bproducer\x18\x02 \x01(\v2\x1f.kratos.api.Data.Kafka.ProducerR\bproducer\x12;\n" +
	"\bconsumer\x18\x03 \x01(\v2\x1f.kratos.api.Data.Kafka.ConsumerR\bconsumer\x1at\n" +
	"\bProducer\x12\x14\n" +
	"\x05topic\x18\x01 \x01(\tR\x05topic\x12\x1d\n" +
	"\n" +
	"batch_size\x18\x02 \x01(\x05R\tbatchSize\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x1ag\n" +
	"\bConsumer\x12\x19\n" +
	"\bgroup_id\x18\x01 \x01(\tR\agroupId\x12\x14\n" +
	"\x05topic\x18\x02 \x01(\tR\x05topic\x12*\n" +
	"\x11auto_offset_reset\x18\x03 \x01(\tR\x0fautoOffsetResetB\x1cZ\x1aDemoApp/internal/conf;confb\x06proto3"
