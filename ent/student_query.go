...
func (sq *StudentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Student, error) {
	...
	if query := sq.withClasses; query != nil {
		if err := sq.loadClasses(ctx, query, nodes, nil,
			func(n *Student, e *Class) { n.Edges.Classes = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (sq *StudentQuery) loadClasses(ctx context.Context, query *ClassQuery, nodes []*Student, init func(*Student), assign func(*Student, *Class)) error {
...
func (sq *StudentQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := sq.ctx.Fields; len(fields) > 0 {
		...
		if sq.withClasses != nil {
			_spec.Node.AddColumnOnce(student.FieldClassID)
		}
	}
