...
const (
	StudentService_CreateStudent_FullMethodName = "/helloworld.v1.StudentService/CreateStudent"
	StudentService_UpdateStudent_FullMethodName = "/helloworld.v1.StudentService/UpdateStudent"
	StudentService_DeleteStudent_FullMethodName = "/helloworld.v1.StudentService/DeleteStudent"
	StudentService_ListStudent_FullMethodName   = "/helloworld.v1.StudentService/ListStudent"
	StudentService_GetStudent_FullMethodName    = "/helloworld.v1.StudentService/GetStudent"
)
...
func (c *studentServiceClient) ListStudent(ctx context.Context, in *ListStudentRequest, opts ...grpc.CallOption) (*ListStudentReply, error) {
	...
	err := c.cc.Invoke(ctx, StudentService_ListStudent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var StudentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/helloworld/v1/studentservice.proto",
}
